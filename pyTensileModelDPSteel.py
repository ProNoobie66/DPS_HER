...
model.materials['DP Steel'].Plastic(
    table=((391.09558e-6, 0.0), (449.3053137e-6, 0.003045919), (494.4013464e-6, 0.00930571),
           (531.8412594e-6, 0.018590825), (565.7182048e-6, 0.028843932), (594.3309203e-6, 0.040275795),
           (619.3229891e-6, 0.052320065), (641.6317208e-6, 0.064745475), (660.7841464e-6, 0.077497753),
           (678.3416248e-6, 0.090470826), (694.0209775e-6, 0.103655957), (707.5533536e-6, 0.116944257),
           (720.3426705e-6, 0.130388436), (731.2873431e-6, 0.143904754), (740.5952913e-6, 0.157490893),
           (747.8894289e-6, 0.171112221), (752.1646528e-6, 0.184914886), (753.0648037e-6, 0.198742115),
           (753.2674725e-6, 0.202191939)))

model.Material(name='Martensite')
model.materials['Martensite'].Elastic(table=((0.225, 0.3),))
model.materials['Martensite'].Plastic(
    table=((1506.83447e-6, 0.0), (1507.5e-6, 1.7e-05), (1583.749217e-6, 0.000142766), (1659.93414e-6, 0.000308327),
           (1736.151251e-6, 0.000626444), (1812.368335e-6, 0.001134407), (1888.585418e-6, 0.001891694),
           (1964.802502e-6, 0.002999662), (2041.019585e-6, 0.004650164), (2117.236669e-6, 0.007276208),
           (2193.453752e-6, 0.012263619), (2269.57e-6, 0.18943869)))
model.Material(name='Ferrite')
model.materials['Ferrite'].Elastic(table=((0.21, 0.3),))
model.materials['Ferrite'].Plastic(table=((303.6851816e-6, 0.0), (322.1037187e-6, 0.002096385), (340.5222556e-6, 0.005395182),
                                          (358.9407922e-6, 0.009946118), (377.3593285e-6, 0.015820343),
                                          (395.7778642e-6, 0.023113982),
                                          (414.1963992e-6, 0.031953744), (432.6149334e-6, 0.042505035),
                                          (451.0334663e-6, 0.054983778),
                                          (469.4519976e-6, 0.069673965), (487.8705266e-6, 0.0869544),
                                          (506.2890524e-6, 0.107340882),
                                          (524.7075735e-6, 0.131555765), (543.1260875e-6, 0.160649168),
                                          (561.5445901e-6, 0.196225817)))
...
# merging instances
assembly.InstanceFromBooleanMerge(name='Sample', instances=selectedInstances, keepIntersections=ON,
...
sample.SectionAssignment(region=region, sectionName='FerriteSection', offset=0.0, offsetType=MIDDLE_SURFACE,
...
sample.SectionAssignment(region=sample.sets['Set-Martensite'], sectionName='MartensiteSection', offset=0.0,
...
model.StaticStep(name='Step-1', previous='Initial', maxNumInc=1000, initialInc=0.001, minInc=1e-8, maxInc=0.05,
                 nlgeom=ON)
print('Created Step')
...
model.DisplacementBC(name='BC-2', createStepName='Step-1', region=region, u1=0.0, u2=12.0, u3=0.0, ur1=0.0, ur2=0.0,
